...
def ensemble_concat(base_path='../LSTM/all',n_cats=27):
    def concat_helper(out_path,in_path):
        apply_concat(base_path,in_path,out_path)
    return ensemble.EnsembleFun(in_fun=lambda x:x,out_fun=concat_helper,n_paths=n_cats)
